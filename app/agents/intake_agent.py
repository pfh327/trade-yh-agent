...
INTENT_KEYWORDS = {
    "oem_odm": ["oem", "odm", "제작", "생산", "로고", "샘플", "맞춤", "라벨", "패키지", "도면", "의뢰"],
    "purchasing_agent": ["구매대행", "1688", "타오바오", "알리바바", "링크", "구매", "사입", "공급처", "소량"],
    "market_research": ["시장조사", "이우", "조사", "공장", "공급처", "가격 조사", "도매"],
    "defect_claim": ["불량", "파손", "클레임", "환불", "교환", "하자", "분쟁", "보상", "납품", "다릅니다", "작동하지", "깨졌"],
    "logistics_customs": ["통관", "물류", "배송", "운송", "원산지", "kc", "인증", "관세", "해운", "항공"],
}
...
class IntakeAgent:
    ...
    def _field_appears(self, field: str, lowered_query: str) -> bool:
        hints = {
            "제품명": ["제품", "상품", "라벨", "의류", "부품", "박스", "포장", "용기", "공구", "모자", "썬캡", "팔토시"],
            ...
            "문의 목적": ["문의", "가능", "상담", "처음", "의뢰"],
            "제품 정보": ["제품", "상품", "회사", "모자", "썬캡", "팔토시"],
            "희망 일정": ["일정", "납기", "언제"],
        }
